...
class MGUCell(Design):
    def __init__(
        ...
        self._fnh_hadamard = fnh_hadamard
        ...
        self.fnh_hadamard_design = self._fnh_hadamard.create_design(
            name=self._fnh_hadamard.name
        )
    ...
    def save_to(self, destination: Path) -> None:
        ...
        self.fnh_hadamard_design.save_to(destination.create_subpath(self._fnh_hadamard.name))
        ...
        template = InProjectTemplate(
            ...
            parameters=dict(
                ...
                fnh_hadamard_x_addr_width=str(self.fnh_hadamard_design._x_addr_width),
                fnh_hadamard_y_addr_width=str(self.fnh_hadamard_design._y_addr_width),
