...
architecture rtl of ${name} is
    ...
    begin
       ...
       with concatenate_n_done select fh_hadamard_product_y_address <=
       concatenate_n_x_2_address when '0',
       ...
       inst_${name}_concatenate: entity ${work_library_name}.${name}_concatenate(rtl)
        ...
        concatenate_n_enable <= fh_hadamard_product_done;
        concatenate_n_clock <= clock;
        concatenate_n_x_1 <= x_1;
        concatenate_n_x_2 <= fh_hadamard_product_y;
        ...
        fn_hadamard_product_enable <= f1_subtraction_done and n_gate_linear_done;
        fn_hadamard_product_clock <= clock;
        f1_subtraction_y_address <= fn_hadamard_product_x_1_address;
        n_gate_linear_y_address <= fn_hadamard_product_x_2_address;
