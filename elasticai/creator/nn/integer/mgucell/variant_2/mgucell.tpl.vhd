...
entity ${name} is
    generic(
        ...
        FNH_HADAMARD_X_ADDR_WIDTH : integer := ${fnh_hadamard_x_addr_width};
        FNH_HADAMARD_Y_ADDR_WIDTH : integer := ${fnh_hadamard_y_addr_width};
    ...
    port(
        ...
        x_2_address : out std_logic_vector(F_LINEAR_X_ADDR_WIDTH -1 downto 0);
...
architecture rtl of ${name} is
    ...
    signal n_addition_x_2_address : std_logic_vector(NH_LINEAR_Y_ADDR_WIDTH - 1 downto 0);
    ...
    signal fnh_hadamard_product_enable : std_logic;
    signal fnh_hadamard_product_clock : std_logic;
    signal fnh_hadamard_product_x_1_address : std_logic_vector(FNH_HADAMARD_X_ADDR_WIDTH - 1 downto 0);
    signal fnh_hadamard_product_x_2_address : std_logic_vector(FNH_HADAMARD_X_ADDR_WIDTH - 1 downto 0);
    signal fnh_hadamard_product_x_1 : std_logic_vector(DATA_WIDTH - 1 downto 0);
    signal fnh_hadamard_product_x_2 : std_logic_vector(DATA_WIDTH - 1 downto 0);
    signal fnh_hadamard_product_y_address : std_logic_vector(FNH_HADAMARD_Y_ADDR_WIDTH - 1 downto 0);
    signal fnh_hadamard_product_y: std_logic_vector(DATA_WIDTH - 1 downto 0);
    signal fnh_hadamard_product_done : std_logic;
    ...
    begin
       ...
       ---Logic for switching x_2 address
       with f_gate_linear_done select x_2_address <= 
       f_gate_linear_x_address when '0',
    ...
    --    f1_subtraction_x_2_address when others;
       ----------------------------------------------
        ...
        inst_${name}_nh_gate_linear: entity ${work_library_name}.${name}_nh_linear(rtl)
        port map (
        ...
        f_gate_linear_enable <= enable;
        f_gate_linear_clock <= clock;
        f_gate_linear_x <= x_2;
        f_gate_linear_y_address <= fh_hadamard_product_x_1_address;
        ...
        fnh_hadamard_product_enable <= f_gate_linear_done;
        fnh_hadamard_product_clock <= clock;
        nh_gate_linear_y_address <= fnh_hadamard_product_x_2_address;
        fnh_hadamard_product_x_1 <= f_sigmoid_y;
        fnh_hadamard_product_x_2 <= nh_gate_linear_y;
        inst_${name}_fnh_hadamard: entity ${work_library_name}.${name}_fnh_hadamard(rtl)
        port map (
            enable => fnh_hadamard_product_enable,
            clock  => fnh_hadamard_product_clock,
            x_1_address  => fnh_hadamard_product_x_1_address,
            x_2_address  => fnh_hadamard_product_x_2_address,
            y_address  => fnh_hadamard_product_y_address,
            x_1  => fnh_hadamard_product_x_1,
            x_2  => fnh_hadamard_product_x_2,
            y => fnh_hadamard_product_y,
            done  => fnh_hadamard_product_done
        );


        n_addition_enable <= ni_gate_linear_done and fnh_hadamard_product_done;
        n_addition_clock <= clock;
        ni_gate_linear_y_address <= n_addition_x_1_address;
        fnh_hadamard_product_y_address <= n_addition_x_2_address;
        n_addition_x_1 <= ni_gate_linear_y;
        n_addition_x_2 <= fnh_hadamard_product_y;
        ...
        fh_hadamard_product_y_address <= h_addition_x_2_address;
