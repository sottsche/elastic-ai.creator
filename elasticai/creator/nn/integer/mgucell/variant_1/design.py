    ...
    def save_to(self, destination: Path) -> None:
        ...
        template_test = InProjectTemplate(
           ...
           parameters=dict(
               ...
               x_2_addr_width=str(self.fh_linear_design._x_addr_width),
               ...
               x_2_num_features=str(self.fh_linear_design._x_count),
               x_2_num_dimensions=str(self.fh_linear_design._num_dimensions),
