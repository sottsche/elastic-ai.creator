...
entity ${name} is
    ...
    signal mgu_cell_y_address, temp_addr : std_logic_vector(log2(Y_2_COUNT) -1 downto 0);
...
begin
    ...
    temp_addr <= cell_y_read_addr when mgu_cell_done='1' else mgu_cell_x_2_address;

    mgu_cell_y_address <= y_2_address when cell_state = s_done else temp_addr;
    ...
    cell_y_store_data <= mgu_cell_y_data;
